...
<script type="application/ld+json">`;
  ...
  let contentEnd = `
</script><!--FAQPage Code Generated by https://blanla.com/projects/faq-page-generator-json-ld-schema/-->
      `;
    ...
    case 'html':
      ...
      <div class="faqContainer fullwidthFaq">
        <div class="faq__accordion">`;

      let htmlContentEnd = `
        </div>
      </div><!--FAQPage Code Generated by https://blanla.com/projects/faq-page-generator-json-ld-schema/-->`;
      ...
      let outputStyle = obj.length > 0 ? style : '';
      data = outputStyle +  htmlContent;
